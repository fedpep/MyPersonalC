/**
  @page Radio_generic_example Radio generic example readme

  @verbatim
  ******************** (C) COPYRIGHT 2011 STMicroelectronics *******************
  * @file    examples/RadioGeneric/SDK_Radio_readme.txt
  * @author  High End Analog & RF BU - AMS / ART Team IMS-Systems Lab
  * @version V2.0.2
  * @date    Febrary 7, 2012
  * @brief   Radio configuration example.
  ******************************************************************************
...
choice.
The two programs implement a transmitter (A) and a receiver (B) of STack
packets with numbers from 1 to 20 for payload.
The user can change the radio parameters during runtime for both the devices.
...
@par Directory contents
  ...
  - SDK_Radio_A.c			Transmitter code
  
  - SDK_Radio_B.c      		 	Receiver code
  
  - SDK_RadioCommon.c and .h    	Common functions
