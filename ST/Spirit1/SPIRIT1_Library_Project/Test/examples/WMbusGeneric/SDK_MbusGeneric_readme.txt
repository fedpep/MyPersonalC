/**
  @page WMBUS_generic_example WMBUS generic example readme

  @verbatim
  ******************** (C) COPYRIGHT 2011 STMicroelectronics *******************
  * @file    examples/WMbusGeneric/SDK_MbusGeneric_readme.txt
  * @author  High End Analog & RF BU - AMS / ART Team IMS-Systems Lab
  * @version V2.0.2
  * @date    Febrary 7, 2012
  * @brief   MBUS packets transmission/reception example.
  ******************************************************************************
...
in order to do a simple mbus packet transmission.
...
@par Directory contents
  ...
  - SDK_MbusGeneric_A.c		 Transmitter code
  
  - SDK_MbusGeneric_B.c      	 Receiver code
