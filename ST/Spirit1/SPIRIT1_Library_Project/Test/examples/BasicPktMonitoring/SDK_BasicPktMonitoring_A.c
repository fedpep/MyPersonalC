/**
* @file    SDK_BasicPktMonitoring_A.c
...
/**
* @addtogroup SDK_Basic_packet_monitoring_A                    SDK Basic packet monitoring A
* @brief Example of configuration and management of SPIRIT Basic packets on the transmitter side.
...
/**
* @defgroup Basic_packet_monitoring_A_Private_TypesDefinitions                 Basic packet monitoring A Private TypesDefinitions
* @{
*/
...
/**
* @defgroup Basic_packet_monitoring_A_Private_Defines                          Basic packet monitoring A Private Defines
* @{
*/
...
/**
* @defgroup Basic_packet_monitoring_A_Private_Macros                           Basic packet monitoring A Private Macros
* @{
*/
...
/**
* @defgroup Basic_packet_monitoring_A_Private_Variables                        Basic packet monitoring A Private Variables
* @{
*/
...
/**
* @defgroup Basic_packet_monitoring_A_Private_FunctionPrototypes                               Basic packet monitoring A Private FunctionPrototypes
* @{
*/
...
/**
* @defgroup Basic_packet_monitoring_A_Private_Functions                                        Basic packet monitoring A Private Functions
* @{
*/
...
void main (void)
{
  ...
  */
  ...
  /* infinite loop */
  while (1){    
    /* print menu for the device A */
    pktMonPrintMenu();
    
    /* while there are no received data in the VCOM RX buffer */
    {
      /* fit the TX FIFO */
