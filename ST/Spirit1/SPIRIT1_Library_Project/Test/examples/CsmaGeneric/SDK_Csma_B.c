...
/**
* @defgroup Csma_B_Private_TypesDefinitions            CSMA B Private TypesDefinitions
* @{
*/
...
/**
* @defgroup Csma_B_Private_Defines                     CSMA B Private Defines
* @{
*/
...
#define SEED_RELOAD_EN                  S_DISABLE
#define MAX_NB                          5
...
/**
* @defgroup Csma_B_Private_Macros                              CSMA B Private Macros
* @{
*/
...
/**
* @defgroup Csma_B_Private_Variables                           CSMA B Private Variables
* @{
*/
...
/*
* @brief RQ status struct declaration
*/
...
/**
* @defgroup Csma_B_Private_FunctionPrototypes                          CSMA B Private FunctionPrototypes
* @{
*/
...
/**
* @defgroup Csma_B_Private_Functions                                   CSMA B Private Functions
* @{
*/
