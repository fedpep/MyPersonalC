...
Every time A performs a transmission (i.e. it transmits a packet and receive an ACK or ACK
with piggybacking payload) it toggles the LED1.
If the max number of transmission is reached the LED2 is toggled.
...
- LED3 to say that a transmission (of ACK or ACK with piggybacking payload) has been done
