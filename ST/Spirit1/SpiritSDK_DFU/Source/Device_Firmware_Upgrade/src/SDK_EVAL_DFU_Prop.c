/**
 * @file     SDK_EVAL_DFU_Prop.c
 * @author   MSH RF/ART Team IMS-Systems Lab
 * @version  V1.0.0
 * @date     03/07/2011
 * @brief    All processings APIs related to DFU.
 * @details
 *
...
/** @addtogroup SDK_EVAL_DFU_Processing
 * @{
 */


/** @defgroup SDK_EVAL_DFU_Processing_Private_TypesDefinitions      SDK EVAL DFU Processing Private TypesDefinitions
 * @{
 */
...
/** @defgroup SDK_EVAL_DFU_Processing_Private_Defines      SDK EVAL DFU Processing Private Defines
 * @{
 */
...
/** @defgroup SDK_EVAL_DFU_Processing_Private_Macros      SDK EVAL DFU Processing Private Macros
 * @{
 */
...
/** @defgroup SDK_EVAL_DFU_Processing_Private_Variables     SDK EVAL DFU Processing Private Variables
 * @{
 */
...
ONE_DESCRIPTOR Device_Descriptor =
  {
    (uint8_t*)g_vectcDFUDeviceDescriptor,
    DFU_SIZ_DEVICE_DESC
  };

ONE_DESCRIPTOR Config_Descriptor =
  {
    (uint8_t*)g_vectcDFUConfigDescriptor,
    DFU_SIZ_CONFIG_DESC
  };
...
/** @defgroup SDK_EVAL_DFU_Processing_Extern_Variables     SDK EVAL DFU Processing Extern Variables
 * @{
 */
...
/** @defgroup SDK_EVAL_DFU_Processing_Private_FunctionPrototypes    SDK EVAL DFU Processing Private FunctionPrototypes
 * @{
 */
...
/** @defgroup SDK_EVAL_DFU_Processing_Private_Functions      SDK EVAL DFU Processing Private Functions
 * @{
 */
...
void DFU_Reset(void)
{
  ...
  pInformation->Current_Feature = g_vectcDFUConfigDescriptor[7];
